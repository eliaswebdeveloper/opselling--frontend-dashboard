...
import { performSignup } from '../infrastructure/auth/api';
import { setAuthSession } from '../infrastructure/server/auth';
import type { GlobalContextData } from '../infrastructure/server/global-context';

...
export const MediaVisibilityEnum = z.enum(['private', 'internal', 'published']);
...
export const BindingFilterEnum = z.enum(['all', 'bound', 'unbound']);
...
export type MediaFileListItem = z.infer<typeof MediaFileListItemSchema>;
...
export type MediaGroupListItem = z.infer<typeof MediaGroupListItemSchema>;
...
export type MediaGroupDraft = z.infer<typeof MediaGroupDraftSchema>;
...
export type MediaFileDraft = z.infer<typeof MediaFileDraftSchema>;
